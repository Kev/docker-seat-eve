...
RUN apt-get update && apt-get install -y procps curl mysql-client rsyslog supervisor php7.1-mysql php7.1-fpm php7.1-cli php7.1-common php7.1-mcrypt php7.1-intl php7.1-curl php7.1-gd nginx redis-server git supervisor && apt-get clean && rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/* /usr/share/doc/*
